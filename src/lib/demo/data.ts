...
export const DEMO_TRANSACTIONS: Transaction[] = [
  { id: "t001", tenantId: DEMO_TENANT_ID, idempotencyKey: "demo-1", amount: "48700.00", currency: "USD", senderName: "Quantum Payments Ltd", senderCountry: "NG", receiverName: "EuroConnect GmbH", receiverCountry: "DE", paymentRail: "swift", riskScore: "0.912", status: "flagged", metadataText: null, createdAt: daysAgo(0, 2, 14) },
  { id: "t002", tenantId: DEMO_TENANT_ID, idempotencyKey: "demo-2", amount: "23100.00", currency: "USD", senderName: "TechFlow Solutions", senderCountry: "BR", receiverName: "Pacific Trade Ltd", receiverCountry: "US", paymentRail: "wire", riskScore: "0.781", status: "flagged", metadataText: null, createdAt: daysAgo(0, 4, 32) },
  ...
  { id: "t004", tenantId: DEMO_TENANT_ID, idempotencyKey: "demo-4", amount: "15800.00", currency: "USD", senderName: "Apex Digital LLC", senderCountry: "VN", receiverName: "Americas Wholesale", receiverCountry: "CA", paymentRail: "wire", riskScore: "0.724", status: "flagged", metadataText: null, createdAt: daysAgo(0, 8, 45) },
  ...
  { id: "t006", tenantId: DEMO_TENANT_ID, idempotencyKey: "demo-6", amount: "92400.00", currency: "USD", senderName: "NorthEdge Capital", senderCountry: "KE", receiverName: "Swift Logistics", receiverCountry: "GB", paymentRail: "swift", riskScore: "0.891", status: "blocked", metadataText: null, createdAt: daysAgo(1, 3, 22) },
  ...
  { id: "t008", tenantId: DEMO_TENANT_ID, idempotencyKey: "demo-8", amount: "31200.00", currency: "USD", senderName: "OceanGate Trading", senderCountry: "MX", receiverName: "United Merchants", receiverCountry: "US", paymentRail: "wire", riskScore: "0.698", status: "flagged", metadataText: null, createdAt: daysAgo(1, 14, 18) },
  { id: "t009", tenantId: DEMO_TENANT_ID, idempotencyKey: "demo-9", amount: "45.00", currency: "USD", senderName: "PrimeShift Inc", senderCountry: "BD", receiverName: "Digital Commerce Hub", receiverCountry: "IN", paymentRail: "crypto", riskScore: "0.612", status: "flagged", metadataText: null, createdAt: daysAgo(2, 7, 33) },
...
export const DEMO_ALERT_ROWS = [
  { id: DEMO_RECENT_ALERTS[0].id, title: DEMO_RECENT_ALERTS[0].title, severity: "critical", status: "open", createdAt: DEMO_RECENT_ALERTS[0].createdAt, assignedTo: null, ruleName: "Very high-value transfer", amount: "48700.00", currency: "USD", senderCountry: "NG", receiverCountry: "DE" },
  { id: DEMO_RECENT_ALERTS[1].id, title: DEMO_RECENT_ALERTS[1].title, severity: "high", status: "investigating", createdAt: DEMO_RECENT_ALERTS[1].createdAt, assignedTo: null, ruleName: "Cross-border high-value", amount: "23100.00", currency: "USD", senderCountry: "BR", receiverCountry: "US" },
  { id: DEMO_RECENT_ALERTS[2].id, title: DEMO_RECENT_ALERTS[2].title, severity: "high", status: "open", createdAt: DEMO_RECENT_ALERTS[2].createdAt, assignedTo: null, ruleName: "High-risk origin", amount: "15800.00", currency: "USD", senderCountry: "VN", receiverCountry: "CA" },
  { id: DEMO_RECENT_ALERTS[3].id, title: DEMO_RECENT_ALERTS[3].title, severity: "critical", status: "escalated", createdAt: DEMO_RECENT_ALERTS[3].createdAt, assignedTo: null, ruleName: "Extreme risk score", amount: "92400.00", currency: "USD", senderCountry: "KE", receiverCountry: "GB" },
  { id: "d0000001-0000-4000-8000-000000000006", title: "MEDIUM: High-risk destination", severity: "medium", status: "open", createdAt: daysAgo(0, 1, 5), assignedTo: null, ruleName: "High-risk destination", amount: "8200.00", currency: "USD", senderCountry: "US", receiverCountry: "NG" },
